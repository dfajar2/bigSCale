function [driving_genes genes_related score D]= population_calling_v2( total_data ,bad_indexes,option_coreg)
...
% bad_indexes: optioanl, force these genes to be excluded from
% overdispersed ones
